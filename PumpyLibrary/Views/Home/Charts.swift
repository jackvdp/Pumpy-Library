...
struct AnalyticsView<N: NowPlayingProtocol>: View {
    
    @EnvironmentObject var nowPlayingManger: N
...
struct AnalyticsView_Previews: PreviewProvider {
    ...
    static var npm = MockNowPlayingManager()
    ...
    static var previews: some View {
        ...
        return NavigationView {
            AnalyticsView<MockNowPlayingManager>().environmentObject(npm)
        }
    }
}
#endif
